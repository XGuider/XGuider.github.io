...
(0,workbox_precaching__WEBPACK_IMPORTED_MODULE_0__.precacheAndRoute)([{'revision':'f67204d5a91decfbe89e3c2fb1606a53','url':'main.bundle.js'}]);

// Cache CSS files with stale-while-revalidate strategy
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_1__.registerRoute)(({
  request
}) => request.destination === 'style', new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.StaleWhileRevalidate({
  cacheName: 'css-cache',
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_1__.registerRoute)(({
  request
}) => request.destination === 'script', new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.StaleWhileRevalidate({
  cacheName: 'js-cache',
  plugins: [new workbox_cacheable_response__WEBPACK_IMPORTED_MODULE_4__.CacheableResponsePlugin({
    statuses: [0, 200]
  }), new workbox_expiration__WEBPACK_IMPORTED_MODULE_3__.ExpirationPlugin({
...
(0,workbox_routing__WEBPACK_IMPORTED_MODULE_1__.registerRoute)(({
  request
}) => request.destination === 'font', new workbox_strategies__WEBPACK_IMPORTED_MODULE_2__.CacheFirst({
